...
class CanIWriteTable extends WP_List_Table {
	...
	function process_bulk_action() {
		...
		if (!isset($_GET['req'])) { return; } // se non ci sono id, significa che non c'è stata azione.
		...
		if( 'accept'===$this->current_action() ) {
			...
			// - è inutile fare una query per ogni giro del foreach, basta farla solo al termine del ciclo.
